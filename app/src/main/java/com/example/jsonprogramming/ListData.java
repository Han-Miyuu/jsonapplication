                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                model.setOriginal_title(jsonObject.getString("original_title"));
                                model.setOverview(jsonObject.getString("overview"));
                                model.setRelease_date(jsonObject.getString("release_date"));
                                model.setPoster_path("https://image.tmdb.org/t/p/w500"+jsonObject.getString("poster_path"));
                                model.setAdult(jsonObject.getBoolean("adult"));
                                model.setVote_count(jsonObject.getInt("vote_count"));
